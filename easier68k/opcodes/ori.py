...
class Ori(Opcode):
    ...
    def command_matches(cls, command: str) -> bool:
        ...
        """
        return command_matches(command, 'ORI')
    ...
    def is_valid(cls, command: str, parameters: str) -> (bool, list):
        ...
        """
        return n_param_is_valid(command, parameters, "ORI", 2, param_invalid_modes=[
    ...
    def from_str(cls, command: str, parameters: str):
        ...
        """
        return n_param_from_str(command, parameters, Ori, 2, OpSize.WORD)
